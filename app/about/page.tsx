...
import {
  Target, Eye, Heart, Award, Users, MapPin, School,
  GraduationCap, Sparkles, ArrowRight, BookOpen, Lightbulb, CheckCircle2,
} from 'lucide-react';
...
import { TrustedBy, Statistics, Features } from '@/components/sections/stats-features';
...
const whyChoose = [
  { icon: 'Target', title: 'Mathematics Only', description: 'We teach one subject and teach it better than anyone. Single-subject mastery means deeper, more focused learning.' },
  { icon: 'MapPin', title: 'Offline Classroom Only', description: 'No online distractions. Face-to-face coaching where doubts are resolved instantly and every student matters.' },
  { icon: 'Users', title: 'Small Batch Size', description: 'Limited students per batch ensures personal attention and interactive learning in every class.' },
  { icon: 'GraduationCap', title: 'Taught by N. M. Sir', description: 'Every class is personally taught by N. M. Sir. No substitutes, no recorded lectures replacing live teaching.' },
  { icon: 'BookOpen', title: 'Premium Study Material', description: 'Research-backed notes, formula sheets, and practice sets designed from 15+ years of teaching experience.' },
  { icon: 'Award', title: 'Proven Results', description: '20,000+ students taught, 1,500+ top rankers, and a 98% success rate over a decade of excellence.' },
];
...
const mathExcellence = [
  { title: 'Concept Clarity', description: 'Every topic starts with the fundamental "why" before the "how", ensuring deep understanding.' },
  { title: 'Problem-Solving Mastery', description: 'Progressive problem sets from basic to advanced that build analytical thinking.' },
  { title: 'Exam Strategy', description: 'Speed techniques, time management, and negative marking strategies for competitive exams.' },
  { title: 'Real-World Application', description: 'Abstract concepts made concrete with real-world examples and visual demonstrations.' },
];
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <FadeUp>
              ...
              <h2 className="font-display text-3xl font-bold sm:text-4xl leading-[1.15] mb-5">
                Where Mathematics Meets <span className="text-gradient">Mastery</span>
              </h2>
              <div className="space-y-4 text-sm sm:text-base text-muted-foreground leading-relaxed">
                <p>
                  Right Concept of Mathematics (RCM) was founded with a single mission: to teach mathematics the way it should be taught — with clarity, passion, and unwavering focus on concepts. We are not a multi-subject coaching factory. We teach mathematics only, and we teach it in offline classrooms only.
                </p>
                <p>
                  For over 15 years, N. M. Sir has personally taught every batch at RCM. There are no substitute teachers, no online lectures replacing live classes, and no divided attention. When a student joins RCM, they learn directly from N. M. Sir in a focused, face-to-face classroom environment where every doubt is resolved instantly and every student receives personal attention.
                </p>
                <p>
                  We cover Class 11, Class 12, JEE Main, and JEE Advanced mathematics. Our students have consistently achieved extraordinary results — 120+ JEE selections in 2025 alone, and a 98% success rate across board and competitive exams.
                </p>
              </div>
            </FadeUp>
            <FadeUp delay={0.2}>
      ...
      <section className="relative py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {whyChoose.map((item) => {
              const icons = { Target, MapPin, Users, GraduationCap, BookOpen, Award };
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <FadeUp>
              ...
              <h2 className="font-display text-3xl font-bold sm:text-4xl leading-[1.15] mb-5">
                The Power of <span className="text-gradient">Face-to-Face</span> Learning
              </h2>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-6">
                In an era where everything is going online, we believe mathematics is best learned in a physical classroom. The offline environment at RCM is designed to maximize focus, interaction, and results. No notifications, no connectivity issues, no isolation — just pure, focused learning.
              </p>
            ...
            <FadeUp delay={0.2}>
              <div className="relative">
                <div className="absolute -inset-4 rounded-3xl bg-brand-gradient opacity-10 blur-2xl" />
                <img
                  src="https://images.pexels.com/photos/5212702/pexels-photo-5212702.jpeg?auto=compress&cs=tinysrgb&w=800"
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: Lightbulb, title: 'Concept First', description: 'Fundamentals before formulas. Understanding before memorization.' },
              { icon: Users, title: 'Personal Attention', description: 'Small batches ensure every student gets individual focus from N. M. Sir.' },
              { icon: Target, title: 'Progress Tracking', description: 'Regular assessments identify weak areas for targeted improvement.' },
              { icon: Sparkles, title: 'Doubt Resolution', description: 'Face-to-face doubt clearing after every class, no question left unanswered.' },
            ].map((item) => (
              <StaggerItem key={item.title}>
                <motion.div
                  whileHover={{ y: -8 }}
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-emerald-600 to-secondary p-8 sm:p-12 text-center premium-shadow">
              ...
              <div className="relative">
                ...
                <p className="text-white/80 text-sm sm:text-base max-w-xl mx-auto mb-7">
                  Join Right Concept of Mathematics and learn from N. M. Sir in a focused offline classroom. Your journey to mathematical excellence starts here.
                </p>
