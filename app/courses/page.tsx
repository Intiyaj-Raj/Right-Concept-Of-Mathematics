  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-border bg-card premium-shadow">
      ...
      <div className="relative h-56 sm:h-64 overflow-hidden">
        ...
        />
        <div
          className={`absolute inset-0 bg-gradient-to-t ${course.color} opacity-30 mix-blend-multiply`}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-card via-card/40 to-transparent" />
        <div className="absolute bottom-0 left-0 right-0 p-6">
          <span
            className={`inline-block rounded-full px-3 py-1 text-[11px] font-semibold mb-3 ${levelColors[course.level]}`}
          >
            {course.level}
          </span>
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3 mb-6">
          ...
          <div className="rounded-xl border border-border bg-background p-4">
            ...
            <p className="font-display text-base font-bold text-gradient">
              {course.fee}
            </p>
          </div>
        </div>
        ...
        <div className="mb-6 rounded-xl border border-primary/30 bg-primary/5 p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-primary">
              Offline Classroom Coaching Only
            </p>
            <p className="text-xs text-muted-foreground mt-0.5">
              All classes are conducted in-person by N. M. Sir. No online
              classes.
            </p>
          </div>
        </div>
  ...
  return (
    <>
      <PageHero
        ...
        breadcrumb="Courses"
        image="/images/right-concept-of-mathematics-about2.webp"
      />
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get free counselling from N. M. Sir on WhatsApp.
                  </p>
                </div>
              </div>
              <a
